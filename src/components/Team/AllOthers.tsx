...
const AllOthers: React.FC<othersProps> = ({name, linkedin, github}) => {
  return (
    <div>
      <p className={styles.person}>{name} <a href={linkedin}><img className={styles.linkedIn} src={linkedinLogo}/></a><a href={github}><img className={styles.github} src={githubLogo}/></a></p>
    </div>
  )
}
